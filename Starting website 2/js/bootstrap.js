...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) {
    ...
    c.VERSION = "3.3.5", c.DEFAULTS = {
        ...
        }, this), 0)}, c.prototype.toggle = function() {
        var a = !0,
    ...
    c.VERSION = "3.3.5", c.TRANSITION_DURATION = 600, c.DEFAULTS = {
        ...
        pause: "hover",
        wrap: !0,
        keyboard: !0}, c.prototype.keydown = function(a) {
    ...
    c.VERSION = "3.3.5", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        viewport: {
            selector: "body",
            padding: 0}}, c.prototype.init = function(b, c, d) {
        ...
        isNaN(g) && (g = 0), isNaN(h) && (h = 0), b.top += g, b.left += h, a.offset.setOffset(d[0], a.extend({
            using: function(a) {
                d.css({
                    ...
                    left: Math.round(a.left)}) }}, b), 0), d.addClass("in");
        ...
        return "bottom" == a ? {
            top: b.top + b.height,
            left: b.left + b.width / 2 - c / 2 } : "top" == a ? {
            top: b.top - d,
            left: b.left + b.width / 2 - c / 2} : "left" == a ? {
            top: b.top + b.height / 2 - d / 2,
            left: b.left - c} : {
            top: b.top + b.height / 2 - d / 2,
            left: b.left + b.width}}, c.prototype.getViewportAdjustedDelta = function(a, b, c, d) {
        var e = {
            top: 0,
            left: 0};
    ...
    c.VERSION = "3.3.5", c.DEFAULTS = a.extend({}, a.fn.tooltip.Constructor.DEFAULTS, {
        ...
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'}), c.prototype = a.extend({}, a.fn.tooltip.Constructor.prototype), c.prototype.constructor = c, c.prototype.getDefaults = function() {
    ...
    b.VERSION = "3.3.5", b.DEFAULTS = {
        ...
        d.parent(".dropdown-menu").length && (d = d.closest("li.dropdown").addClass("active")),
            d.trigger("activate.bs.scrollspy")}, b.prototype.clear = function() {
        ...
        if (d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active")) {
            ...
            if (e.trigger(f), b.trigger(g), !g.isDefaultPrevented() && !f.isDefaultPrevented()) {
                ...
                this.activate(b.closest("li"), c), this.activate(h, h.parent(), function() {
                    e.trigger({
                        type: "hidden.bs.tab",
                        relatedTarget: b[0]}), b.trigger({
                        type: "shown.bs.tab",
                        relatedTarget: e[0]})})}}}, c.prototype.activate = function(b, d, e) {
        function f() {
    ...
    c.VERSION = "3.3.5", c.RESET = "affix affix-top affix-bottom", c.DEFAULTS = {
        offset: 0,
        target: window}, c.prototype.getState = function(a, b, c, d) {
